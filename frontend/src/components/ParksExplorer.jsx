  ...
  useEffect(() => {
    ...
    debounce.current = setTimeout(() => {
      ...
      fetch(`/api/parks?${params.toString()}`)
        ...
        .then((d) => setData(d))
        .catch(() => setError("Could not reach the API. Is the Flask server running?"))
  ...
  return (
    <div className="explorer">
      <div className="explorer-controls">
        ...
        <select value={type} onChange={(e) => onType(e.target.value)} aria-label="Filter by type">
        ...
        <select value={area} onChange={(e) => onArea(e.target.value)} aria-label="Filter by area">
      ...
      {error ? (
        ...
        <div className="state-msg">No parks match your search. Try clearing a filter.</div>
      ) : (
